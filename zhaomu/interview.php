...
<div class="h2"><strong>诚聘英才</strong></div>
<div class="about_right_c">
<?php echo '<h2><p>姓名：'.$name.'</p></h2>'?>
<?php echo '<h2><p>性别：'.$sex.'</p></h2>'?>
<?php echo '<h2><p>年龄：'.$age.'</p></h2>'?>
<?php echo '<h2><p>年级：'.$grade.'</p></h2>'?>
<?php echo '<h2><p>院系：'.$departments.'</p></h2>'?>
<?php echo '<h2><p>专业：'.$subject.'</p></h2>'?>
<?php echo '<h2><p>地址：'.$address.'</p></h2>'?>
<?php echo '<h2><p>电话：'.$phonenumber.'</p></h2>'?>
<?php echo '<h2><p>Q  Q：'.$QQnumber.'</p></h2><br>'?>
<?php echo '<h2><p>申请职位：'.$position.'</p></h2>'?>
<?php echo '<h2><p>职位认知：</h2><p>'.$understand.'</p><br><br>'?>
<?php echo '<h2><p>掌握技能：</h2><p>'.$skill.'</p><br><br>'?>
<?php echo '<h2><p>自我评价：</h2><p>'.$selfevaluation.'</p><br><br>'?>
</div></div>
...
<span class="mr10"><a id="nav_key_up_47" href="fillresume.html" title="">在线简历</a></span><span class="gray mr10"></span><span class="mr10"><a id="nav_key_up_9" href="question.html" title="">Question&Answer</a></span><span class="gray mr10"></span><span class="gray mr10"></span><span class="mr10"><a id="nav_key_up_7" href="contactus.html" title="">联系我们</a></span>
